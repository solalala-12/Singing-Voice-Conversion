...
DATA_FILES_MP3 = f'{current_dir}/TFMusicAudioEncoder/audio'
DATA_FILES_WAV = f'{current_dir}/TFMusicAudioEncoder/audio_wav'
...
def get_next_batch(curr_batch, songs_per_batch, sess,sample_rate):
	wav_arr_ch1 = []
	wav_arr_ch2 = []
